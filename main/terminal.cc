...
int Terminal::EditTerm(int save_data, int edit_mode)
{
    ...
    WStr("Select\\All");
    WInt8(FONT_TIMES_18); WInt8(COLOR_DK_TEAL); WInt8(COLOR_TEAL);

    WInt8(TERM_PUSHBUTTON);
    WInt16(WB_TOGGLE);
    WInt16(60); WInt16(60); WInt16(60); WInt16(60);
    WStr("Toggle\\Selected");
    WInt8(FONT_TIMES_18); WInt8(COLOR_DK_MAGENTA); WInt8(COLOR_MAGENTA);
    ...
    WInt8(FONT_TIMES_18); WInt8(COLOR_GRAY); WInt8(COLOR_WHITE);

    WInt8(TERM_PUSHBUTTON);
    WInt16(WB_LIST);
    WInt16(60); WInt16(240); WInt16(60); WInt16(60);
    WStr("Show\\Page\\List");
    WInt8(FONT_TIMES_18); WInt8(COLOR_BROWN); WInt8(COLOR_ORANGE);
