...
const genericChar* FullZoneTypeName[] = {
	...
	"Order Comment", "Payment Entry", "Check List",
	"User Edit", "Setting Switch",
    "General Settings", "Tax Settings",
    "Receipt Settings", "Editor Settings", "Calculation Settings",
    "Revenue Groups", "Charge Card Settings", "Report", "Scheduler",
	"Split Check", "Drawer",
	"Drawer Assign", "Printing Targets",
	"Hardware", "Time Settings",
	"Table Assign", "Kill System",
	"Clear System", "Search for keyword", "Split Kitchen",
	"Cash Payout", "End Day",
...
int FullZoneTypeValue[] = {
	...
	ZONE_ORDER_COMMENT, ZONE_PAYMENT_ENTRY, ZONE_CHECK_LIST,
	ZONE_USER_EDIT, ZONE_SWITCH,
	ZONE_SETTINGS, ZONE_TAX_SETTINGS,
    ZONE_RECEIPTS, ZONE_DEVELOPER, ZONE_CALCULATION_SETTINGS,
    ZONE_REVENUE_GROUPS, ZONE_CC_SETTINGS, ZONE_REPORT, ZONE_SCHEDULE,
	...
	ZONE_CLEAR_SYSTEM, ZONE_SEARCH, ZONE_SPLIT_KITCHEN,
    ...
    ZONE_ITEM_SUBSTITUTE, ZONE_ITEM_POUND, ZONE_ITEM_ADMISSION,
    ZONE_INDEX_TAB, -1
};
