...
const genericChar *RStr(const genericChar *s)
{
    FnTrace("RStr()");
...
int Translation::GetKey(const char *store, int maxlen)
{
...
int Translation::GetValue(const char *store, int maxlen)
{
 ...
 ****/
Xpm *LoadPixmapFile(const char *file_name)
{
