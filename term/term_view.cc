             ...
             int set_width, int set_height)
{
    ...
    else if (WinWidth >= 800 && WinWidth < 1024 && WinHeight == 600)			// 4:3
      screen_size = SIZE_800x600;
    else if (WinWidth == 1024 && WinHeight < 768)		// 128:75
        screen_size = SIZE_1024x600;
    else if (WinWidth == 1024 && WinHeight == 768)		// 4:3
        screen_size = SIZE_1024x768;
    else if  (WinWidth >= 1280 && WinHeight < 1024) 		// 16:10
    ...
    else if (WinWidth >= 1920 && WinHeight < 1200) 		// 16:9
